...
urlpatterns = [
	...
	path('<str:given_username>/details/', views.profile, name='profile'),
	path('<str:given_username>/edit/', views.profile_edit, name='profile_edit'),

	#Paths required for password reset
